...
import eu.sqooss.tracer.platform.components.SecurityModelComponent;
...
import eu.sqooss.tracer.platform.components.VulnerabilityDetectionComponent;
import eu.sqooss.tracer.platform.components.VulnerabilityDetectorActivatorComponent;
import eu.sqooss.tracer.platform.components.impl.RestApiComponentImpl;
import eu.sqooss.tracer.platform.components.impl.SecurityModelComponentImpl;
import eu.sqooss.tracer.platform.components.impl.SecurityProfileComponentImpl;
import eu.sqooss.tracer.platform.components.impl.UserComponentImpl;
import eu.sqooss.tracer.platform.components.impl.VulnerabilityDetectionComponentImpl;
import eu.sqooss.tracer.platform.components.impl.VulnerabilityDetectorActivatorComponentImpl;
